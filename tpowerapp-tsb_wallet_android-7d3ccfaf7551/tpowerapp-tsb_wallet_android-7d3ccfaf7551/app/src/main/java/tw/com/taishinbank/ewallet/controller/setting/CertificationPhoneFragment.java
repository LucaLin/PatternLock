...
public class CertificationPhoneFragment extends Fragment implements View.OnClickListener {

    private static final String TAG = "CertificationPhoneFragment";
    ...
    public CertificationPhoneFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((ActivityBase)getActivity()).setHeadline(headline, R.string.register_title2_1, R.string.modify_phone_cert_subtitle);
        ...
        textNotice.setText(String.format(getString(R.string.modify_notice), getString(R.string.modify_notice_phone)));
        return view;
    }
    ...
    public void onResume() {
        super.onResume();
        // 設定隱碼顯示文字
        textShowEncoded.setText(FormatUtil.getEncodedCellPhoneNumber(((UserInfoModifyActivity) getActivity()).phoneNumber));
    ...
    public void onClick(View view){
        ...
        if(viewId == R.id.button_next){
            ...
            try {
                GeneralHttpUtil.modifyPhoneCertCheck(editCode.getText().toString(), checkResponseListener, getActivity(), TAG);
    ...
    private void sendCodeRequest(){
        ...
        try {
            GeneralHttpUtil.modifyPhoneCertRequest(((UserInfoModifyActivity) getActivity()).phoneNumber, responseListener, getActivity(), TAG);
            ((ActivityBase)getActivity()).showProgressLoading();
        } catch (JSONException e) {
            e.printStackTrace();
            // TODO
    ...
    private ResponseListener responseListener = new ResponseListener() {
        ...
        public void onResponse(ResponseResult result) {
            ...
            if(returnCode.equals(ResponseResult.RESULT_SUCCESS)|| !GlobalConst.UseOfficialServer) {
                ...
                if(returnCode.equals(ResponseResult.RESULT_INVALID_PHONE_EXISTED_CODE)) {
                    ((ActivityBase)getActivity()).showAlertDialog(result.getReturnMessage(), android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
    ...
    private ResponseListener checkResponseListener = new ResponseListener() {
        ...
        public void onResponse(ResponseResult result) {
            ...
            if(returnCode.equals(ResponseResult.RESULT_SUCCESS) || !GlobalConst.UseOfficialServer) {
                ...
                intent.putExtra(EditPersonalInfoActivity.EXTRA_CHANGE_ITEM, EditPersonalInfoActivity.ENUM_UPDATE_ITEM.PHONE.toString());
                intent.putExtra(EditPersonalInfoActivity.EXTRA_CHANGE_DATA, ((UserInfoModifyActivity)getActivity()).phoneNumber);
