...
public class RegisterFragment2_2 extends Fragment implements View.OnClickListener {

    private static final String TAG = "RegisterFragment2_2";
    ...
    public static final int PAGE_INDEX = RegisterFragment2_1.PAGE_INDEX + 1;

    public RegisterFragment2_2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((ActivityBase)getActivity()).setHeadline(headline, R.string.register_title2_2, R.string.register_subtitle2_2);
    ...
    public void onResume() {
        ...
        // 設定隱碼顯示文字
        textShowEncoded.setText(FormatUtil.getEncodedEmail(((RegisterActivity) getActivity()).email));

        if(countdownTimer == null){
            // TODO refactor
            countdownTimer = new CountDownTimer(RegisterFragment2_1.TEN_MINUTES + RegisterFragment2_1.ONE_SECOND,
                    RegisterFragment2_1.ONE_SECOND) {

                public void onTick(long millisUntilFinished) {
                    millisUntilFinished -= RegisterFragment2_1.ONE_SECOND;
    ...
    public void onClick(View view){
        ...
        if(viewId == R.id.button_next){
            ...
            try {
                GeneralHttpUtil.emailCertCheck(((RegisterActivity) getActivity()).memNo,
    ...
    private void sendCodeRequest(){
        ...
        try {
            GeneralHttpUtil.emailCertRequest(((RegisterActivity) getActivity()).memNo, responseListener, getActivity(), TAG);
            ((ActivityBase)getActivity()).showProgressLoading();
        } catch (JSONException e) {
            e.printStackTrace();
            // TODO
    ...
    private ResponseListener checkResponseListener = new ResponseListener() {
        ...
        public void onResponse(ResponseResult result) {
            ...
            if(returnCode.equals(ResponseResult.RESULT_SUCCESS)) {
                // 開啟下一頁
                if (mListener != null) {
                    mListener.onButtonNextClicked(RegisterFragment3_1.PAGE_INDEX);
                }
            }else{
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(resetTimer) {
                            ...
                            countdownTimer.cancel();
                            // 重設時間文字與按鈕
                            String str = DateTimeUtil.convertMilliSecondsToMmSs(RegisterFragment2_1.TEN_MINUTES);
                            textCountdownTime.setText(str);
                            buttonSendAgain.setEnabled(true);
                        }
                    }
