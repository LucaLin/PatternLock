...
public class ResetPasswordFragment3 extends Fragment implements View.OnClickListener {

    private static final String TAG = "ResetPasswordFragment3";
    ...
    public static final int PAGE_INDEX = ResetPasswordFragment2.PAGE_INDEX + 1;

    public ResetPasswordFragment3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_reset_password_3, container, false);
        buttonFinish = (Button) view.findViewById(R.id.button_finish);
        buttonFinish.setOnClickListener(this);

        View headline = view.findViewById(R.id.headline);
        ((ActivityBase)getActivity()).setHeadline(headline, R.string.reset_password);
    ...
    public void onClick(View view){
        ...
        if(viewId == R.id.button_finish) {
            ...
            try {
                ...
                GeneralHttpUtil.resetPwdModifyPassword(resetMimaActivity.verifyID, resetMimaActivity.memNo, pwInAES,
    ...
    private ResponseListener responseListener = new ResponseListener() {
        ...
        public void onResponse(ResponseResult result) {
            ...
            if(returnCode.equals(ResponseResult.RESULT_SUCCESS)) {
                // 成功的話，跳至下一頁
                if (mListener != null) {
                    mListener.onButtonNextClicked(ResetPasswordFragment4.PAGE_INDEX);
                }
            }else{
                // 執行預設的錯誤處理 
