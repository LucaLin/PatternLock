...
public class CellBeanCheckingActivity extends AppCompatActivity {
    ...
    public static void startAction(Context context ){
        Intent intent = new Intent(context, CellBeanCheckingActivity.class);
        context.startActivity(intent);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_checking_cell_bean);
