...
import com.dbs.omni.tw.view.ScaleImageView;
...
public class CropImageActivity extends ActivityBase implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(viewId == R.id.button_ok){
            ...
            Bitmap cropBitmap = BitmapUtil.cropCircleWithColor(bitmap, imagePhotoSize * cropCircleDisplayScaleRate, imagePhotoSize * sharedMethods.PhotoSaveSizeScaleRate, imagePhotoCropCircleRadius * sharedMethods.PhotoSaveSizeScaleRate,
            ...
            sharedMethods.checkFolderExists();
