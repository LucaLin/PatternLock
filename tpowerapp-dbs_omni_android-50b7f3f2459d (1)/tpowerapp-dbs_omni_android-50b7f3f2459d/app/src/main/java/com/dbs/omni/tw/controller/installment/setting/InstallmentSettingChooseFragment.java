 ...
 */
public class InstallmentSettingChooseFragment extends Fragment {
    ...
    private InstallmentSettingChooseFragment.OnEventListener onEventListener;

    public interface OnEventListener {
        void OnNextEvent(ArrayList<String> list);
    }

    public void setOnEventListener (InstallmentSettingChooseFragment.OnEventListener listener) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_installment_settting_choose, container, false);
