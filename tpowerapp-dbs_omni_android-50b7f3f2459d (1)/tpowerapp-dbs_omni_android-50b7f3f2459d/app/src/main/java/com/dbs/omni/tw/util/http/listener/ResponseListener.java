...
public abstract class ResponseListener {
    ...
    public static boolean handleCommonError(ResponseResult result, final ActivityBase activityBase){
        ...
        if(returnCode.equals(ResponseResult.RESULT_SESSION_FAIL)) {
            PreferenceUtil.setIsLogin(activityBase, false);
            HttpUtilBase.sessionID = "";
            activityBase.startActivity(new Intent(activityBase, LoginActivity.class));
            return true;
        }
//
//        // 儲值token過期，跳儲值登入頁
